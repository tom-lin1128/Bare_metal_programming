...
#define GPFEN0	      	((volatile unsigned int*)(MMIO_BASE+0x00200054))
#define GPFEN1	      	((volatile unsigned int*)(MMIO_BASE+0x00200058))
...
#define GPAFEN1	      	((volatile unsigned int*)(MMIO_BASE+0x0020007C))
